...
class CustomerListTileState extends State<CustomerTile> {
  ...
  bool get visitLessThan14Days =>
      DateTime.now().difference(lastVisit).inDays > 13;
            ...
            children: [
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(Country.tryParse(user.birthCountry)!.name,
                            style: TextStyle(color: Colors.grey))
                      ],
                    )
                  ],
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(
                        visitLessThan14Days ? Icons.check_circle : Icons.error),
                    SizedBox(width: 5),
                    Expanded(
                      child: Text.rich(
                        softWrap: true,
                        ...
                        TextSpan(
                          children: [
                            ...
                            if (user.lastVisit != -1 &&
                                !Utilities()
                                    .isSameDay(DateTime.now(), lastVisit))
                              TextSpan(
                                text:
                            ...
                            if (user.lastVisit == -1)
                              TextSpan(text: S.of(context).never),
                  ...
                  children: [
                    Expanded(
                      child: Utilities().isSameDay(DateTime.now(), lastVisit)
                          ? TextButton(
                              onPressed: () async {
                                int? newLastTime = await DatabaseHelper()
                                    .updateUserLastVisited(
                                        user); //Löscht den eintrag aus "TookItems" und update den User in "users"
                              ...
                              style: TextButton.styleFrom(
                                  ...
                                  backgroundColor:
                                      Color.fromRGBO(169, 171, 25, 0.4),
                                  shape: RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(8))),
                              child: Text(S.of(context).delete_note),
                            )
                          : TextButton(
                              onPressed: () async {
                                setState(() {
                              ...
                              child: Text(
                                visitLessThan14Days
                                    ? S.of(context).mark_new_visit
                                    : S.of(context).still_note,
                                textAlign: TextAlign.center,
                              ),
                            ),
                    ),
